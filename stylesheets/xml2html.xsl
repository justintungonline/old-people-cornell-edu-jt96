...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:my="http://www.people.cornell.edu/pages/jt96/" xmlns="http://www.w3.org/1999/xhtml" xmlns:html="http://www.w3.org/1999/xhtml" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:xalan="http://xalan.apache.org/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcq="http://purl.org/dc/qualifiers/1.0/" exclude-result-prefixes="html msxsl xalan rdf">

  <xsl:output doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" cdata-section-elements="script" method="xml" />
  ...
  <xsl:variable name="htmlfilename" select="$metadata/rdf:Description[1]/dc:description/@about" />
  <xsl:variable name="xmlfilename" select="$metadata/rdf:Description[1]/@about" />
  <xsl:variable name="pagedescription" select="$metadata/rdf:Description[1]/dc:description" />
  ...
  <xsl:template match="/DOC/HTMLPAGE">
    ...
    <html>
      <head>
        <title>
          <xsl:value-of select="$metadata/rdf:Description[1]/dc:title" />
        </title>

        <link rel="stylesheet" type="text/css" href="{$root}/stylesheets/artemis.css" />
      ...
      <div id="toppanel">
        ...
        <div id="pagepath">
          <div class="flowleft">
            ...
            <br />
            if you have problems consult the
  ...
  <xsl:template match="BODY">
	...
	<xsl:comment>END WebSTAT Activation Code</xsl:comment>
      ...
      <div id="leftpanel">
        <img src="{$root}/images/artemis_tower.jpg" id="artemis_left" alt="artemis on tower" />
      </div>
    </body>
  ...
  <xsl:template match="FOOTER">
    ...
    <hr />
    <p>
      <a href="{$root}/index.html">ARTEMIS</a>
      |
      ...
      by
      <a href="mailto:kalreichi@hotmail.com">justin tung</a>
      generated using
      <xsl:variable name="vendorlocator">
        <xsl:value-of select="system-property('xsl:vendor-url')" />
      </xsl:variable>

      <a href="{$vendorlocator}">
  ...
  <xsl:template match="RIGHTPANEL">
    ...
    <div id="rightpanel">
      <div class="navbar_list">
        <b>
          <span class="navbar_section">
            <a href="{$root}/aboutme/index.html">
	      all</a>
            about me
          </span>
        </b>
        <ul class="none">
          <li class="linknode">
            <a href="{$root}/aboutme/bio.html">bio</a>
          </li>
          <li class="linknode">
            <a href="{$root}/aboutme/interests.html">interests</a>
          </li>
          <li class="linknode">
            <a href="{$root}/aboutme/resume.html">resume</a>
          </li>
        </ul>
        ...
        <b>
          <span class="navbar_section">
            <a href="{$root}/siteinfo/index.html">site info</a>
          </span>
        </b>
        <ul class="none">
          <li class="linknode">
            <a href="{$root}/siteinfo/sitemap.html">sitemap</a>
          </li>
          <li class="linknode">
            <a href="{$root}/siteinfo/support.html">support</a>
          </li>
        </ul>
        ...
        <b>
          <span class="navbar_section">
            <a href="{$root}/resources/index.html">
	      resources</a>
          </span>
        </b>
        <ul class="none">
          <li class="linknode">
            <a href="{$root}/resources/articles.html">
		brief documents</a>
          </li>
          <li class="linknode">
            <a href="{$root}/resources/academic.html">
		essays/project</a>
          </li>
        </ul>
        ...
        <br />
        <b>
          <span class="navbar_section">eXplore with me</span>
        </b>

        <ul class="none">
          <li class="linknode">
            <a href="{$root}/explore/writeme.html">
		contact / write me</a>
          </li>
          <li class="linknode">
            <a href="{$root}/explore/links.html">
		web gateway</a>
          </li>
        </ul>
      </div>
